/**
 * The thirteen tours from the 16 April 2026 catalogue, as data. The seed
 * (seed-tours.ts) turns them into SQL; the cycling map's tests read the
 * slugs to check every tour drawn on the map is a real one.
 */
import { MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY } from "../app/lib/tours/departures";

export type Cat = "bike" | "combo" | "hike" | "trail_run";
export type Diff = "Easy" | "Moderate" | "Advanced";
export type BikeCat = "ebike" | "mountain" | "gravel" | "road";
