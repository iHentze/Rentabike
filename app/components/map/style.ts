...
export const LAYER_GROUPS: Record<LayerGroupId, string[]> = {
  ...
  mainRoads: ["road-main-casing", "road-main", "road-singlelane-ticks", "road-singlelane-casing", "road-singlelane"],
...
export function buildStyle(content: MapContent, scenicNames: string[]): StyleSpecification {
  const layers: LayerSpecification[] = [
    ...
    // A wide, sparse dash under a narrow road reads as the lay-by tick marks.
    {
      ...
      type: "line",
      source: "roads",
      filter: cls("singleLane"),
      minzoom: 9,
      paint: { "line-color": PAPER.yellowCase, "line-width": grow(6, 14), "line-dasharray": [0.18, 2.4] },
    },
    {
      id: "road-singlelane-casing",
      type: "line",
      source: "roads",
      filter: cls("singleLane"),
      layout: { "line-cap": "round", "line-join": "round" },
      paint: { "line-color": PAPER.yellowCase, "line-width": grow(2, 6) },
    },
    {
      id: "road-singlelane",
      type: "line",
      ...
      filter: cls("singleLane"),
      layout: { "line-cap": "round", "line-join": "round" },
      paint: { "line-color": PAPER.yellow, "line-width": grow(1, 3.8) },
    },
    {
